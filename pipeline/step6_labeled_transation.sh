...
DATA_BIN="/path/to/flores/20M/data-bin-split10/data-bin0/"
SPM_MODEL="/path/to/m2m/spm.model"
INPUT_DIR="/path/to/xlmr_augment_v1/translation/LABELED_EN/"
OUTPUT_DIR="/path/to/xlmr_augment_v1/translation/LABELED_X/"
mkdir -p ${OUTPUT_DIR}
...
cat $INPUT | python ./m2m/fairseq_cli/interactive.py ${DATA_BIN} \
  --path ${MODEL} \
