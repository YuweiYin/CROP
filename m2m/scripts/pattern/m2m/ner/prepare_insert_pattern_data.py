...
def parse_args():
    ...
    parser.add_argument('--raw-sentences', '-raw-sentences', type=str,
                        default=r'/path/to/NER/unitrans-data/xlmr_augment_v1/translation/X//es.txt0000',
                        help='input stream')
...
if __name__ == "__main__":
    ...
    if args.raw_sentences != "":
        ...
        logger.info(f"Successfully saving {len(raw_sentences)} examples to {args.raw_sentences}")
