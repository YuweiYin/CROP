...
def parse_args():
    ...
    parser.add_argument('--input', '-input', type=str,
                        default=r'/path/to/NER/xtreme_v0/panx_processed_maxlen128/en/train.xlmr', help='input stream')
    parser.add_argument('--output', '-output', type=str,
                        default=r'/path/to/NER/xtreme_v0/panx_processed_maxlen128/en/translation/src/en0000.txt',
                        help='input stream')
    parser.add_argument('--entity', '-entity', type=str,
                        default=r'/path/to/NER/xtreme_v0/panx_processed_maxlen128/en/translation/src/en0001.txt',
                        help='input stream')
...
if __name__ == "__main__":
    ...
    for index, example in enumerate(examples):
        slot_sentence, entity = example.insert_with_slot(spm)
