...
DATA_DIR=/path/to/NER/unitrans-data/xlmr_augment_v1/translation/NER/
MODEL=/path/to/NER/unitrans-data/xlmr/model/xlmr-bsz32-maxlen128/checkpoint-best/
MAX_LENGTH=128
TEST_OUTPUT_FILE=/path/to/NER/unitrans-data/xlmr_augment_v1/translation/NER/$LANG/test.xlmr.tsv
