SIZE=$1
DATA_DIR=/path/to/NER/xtreme_analysis/data_size/${SIZE}/panx_processed_maxlen128/
...
OUTPUT_DIR=/path/to/NER/xtreme_analysis/data_size/${SIZE}/model/xlmr-bsz${BATCH_SIZE}-maxlen${MAX_LENGTH}-lr${LR}-epoch${EPOCH}-pooling/
mkdir -p $OUTPUT_DIR
