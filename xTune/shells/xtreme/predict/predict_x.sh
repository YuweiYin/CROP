...
DATA_DIR=/path/to/NER/xtreme_v1/translation/X_NER/
MODEL=/path/to/NER/xtreme_v1/model/augment/iter1/xlmr-bsz32-maxlen128-lr1e-5-epoch10/checkpoint-best/
MAX_LENGTH=128
TEST_OUTPUT_FILE=/path/to/NER/xtreme_v1/translation/X_NER/$LANG/test.xlmr.tsv
