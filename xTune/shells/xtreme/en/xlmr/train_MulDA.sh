DATA_DIR=/path/to/NER/xtreme_MulDA/panx_processed_maxlen128/
...
OUTPUT_DIR=/path/to/NER/xtreme_MulDA/model/xlmr-bsz${BATCH_SIZE}-maxlen${MAX_LENGTH}-lr${LR}-epoch${EPOCH}/
mkdir -p $OUTPUT_DIR
