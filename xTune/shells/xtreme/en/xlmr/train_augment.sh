DATA_DIR=/path/to/NER/xtreme_v1/panx_processed_maxlen128/
...
EPOCH=$1
MAX_LENGTH=$2
LANGS="ar,he,vi,id,jv,ms,tl,eu,ml,ta,te,af,nl,de,el,bn,hi,mr,ur,fa,fr,it,pt,es,bg,ru,ja,ka,ko,th,sw,yo,my,zh,kk,tr,et,fi,hu"
...
OUTPUT_DIR=/path/to/NER/xtreme_v1/model/augment/iter2/xlmr-bsz${BATCH_SIZE}-maxlen${MAX_LENGTH}-lr${LR}-epoch${EPOCH}/
mkdir -p $OUTPUT_DIR
