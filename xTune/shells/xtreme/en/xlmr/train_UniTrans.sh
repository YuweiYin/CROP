DATA_DIR=/path/to/NER/xtreme_UniTrans/panx_processed_maxlen128/
...
OUTPUT_DIR=/path/to/NER/xtreme_UniTrans/model/xlmr-bsz${BATCH_SIZE}-maxlen${MAX_LENGTH}-lr${LR}-epoch${EPOCH}/
mkdir -p $OUTPUT_DIR
