DATA_DIR=/path/to/NER/xtreme_bert_translate_train/panx_processed_maxlen128/
...
OUTPUT_DIR=/path/to/NER/xtreme_bert_translate_train/model/bert-bsz${BATCH_SIZE}-maxlen${MAX_LENGTH}-lr${LR}-epoch${EPOCH}/
mkdir -p $OUTPUT_DIR
