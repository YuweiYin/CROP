DATA_DIR=/path/to/NER/xtreme_v0/panx_processed_maxlen128/
...
OUTPUT_DIR=/path/to/NER/xtreme_v0/model/transformer-bsz${BATCH_SIZE}-maxlen${MAX_LENGTH}-epoch${EPOCH}/
mkdir -p $OUTPUT_DIR
