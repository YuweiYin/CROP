...
SEED=1
PRETRAINED_ENCODER_PATH=/path/to/NER/PretrainedModels/transformer
EPOCH=$1
MAX_LENGTH=$2
...
OUTPUT_DIR=/path/to/NER/xtreme_v1/model/augment_v1/iter1/transformer-bsz${BATCH_SIZE}-maxlen${MAX_LENGTH}-lr${LR}-epoch${EPOCH}/
mkdir -p $OUTPUT_DIR
